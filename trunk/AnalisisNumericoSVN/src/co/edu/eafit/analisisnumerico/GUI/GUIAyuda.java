...
public class GUIAyuda extends javax.swing.JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4630155633950564881L;
	
	/** Creates new form Ayuda */
    public GUIAyuda(String title, String ayudaText) {
        initComponents();
        setTitle(title);
        textArea1.setEditable(false);
        textArea1.setText(ayudaText);
        btnRegresar.addActionListener( new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent arg0) {
				GUIAyuda.this.setVisible(false);
				GUIAyuda.this.dispose();
			}
		});
    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIAyuda("desde el main","").setVisible(true);
            }
        });
    }
